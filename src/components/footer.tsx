    ...
    <footer className="bg-white border-t-2 border-gray-200 shadow-[0_-10px_15px_-3px_rgba(0,0,0,0.05)] font-poppins mt-20">
      <div className="container mx-auto px-6 lg:px-20 py-16">
        <div className="grid grid-cols-1 md:grid-cols-12 gap-y-12 md:gap-x-8 lg:gap-x-16">
          ...
          <div className="md:col-span-2">
            ...
            <ul className="flex flex-col gap-4">
              {[
                ...
                { name: t.activeconTitle, href: "/pencarian?status=active" },
                { name: t.inactiveconTitle, href: "/pencarian?status=inactive", },
              ].map((item) => (
                <li key={item.name}>
                  <Link
                    href={item.href}
                    className="text-gray-600 hover:text-[#0056b3] text-sm transition-colors font-medium"
                  >
                    {item.name}
                  </Link>
                </li>
          ...
          {/* TAUTAN RESMI */}
          <div className="md:col-span-2">
            <h4 className="text-[#0056b3] font-bold text-lg mb-6">
              {t.linkTitle}
            </h4>
            <ul className="flex flex-col gap-4">
              {[
                ...
                {
                  name: "MPKKI",
                  href: "https://dgip.go.id/konsultan?kategori=Tentang%20Konsultan%20KI",
                },
              ].map((item) => (
                <li key={item.name}>
                  <Link
                  ...
                  >
                    ...
                    <ExternalLink
                      size={14}
                      className="shrink-0 text-[#0056b3]"
                    />
                  </Link>
                </li>
              ))}
            ...
            <div className="flex flex-col gap-6">
              <div className="flex items-start gap-4">
                ...
                <p className="text-sm text-gray-600 leading-relaxed">
                  ...
                  <br />
                  Jl. HR. Rasuna Said Kav. 8-9, Jakarta Selatan, Jakarta,
                  Indonesia
                </p>
              </div>
      ...
      <div className="bg-[#0042a3] py-4">
        <div className="container mx-auto px-6">
          <p className="text-white text-center text-xs md:text-sm font-medium tracking-wide">
            Copyright ©Direktorat Jenderal Kekayaan Intelektual - Kementerian
            Hukum R.I.
          </p>
        </div>
      </div>
