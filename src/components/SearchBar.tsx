      ...
      >
        ...
        <div className="flex-[3] grid grid-cols-1 md:grid-cols-3 gap-1">
          ...
          <div className="relative">
            ...
            >
              <option value="">{t.regionTitle}</option>
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full h-full py-3 px-4 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-xl cursor-pointer focus:outline-none transition-colors text-sm font-medium border-none font-poppins"
            >
              <option value="">{t.srcformCSTitle}</option>
              {/* Sesuai enum Laravel */}
          ...
          <div className="relative">
            <select
              ...
              className="appearance-none w-full h-full py-3 px-4 bg-gray-50 hover:bg-gray-100 text-gray-600 rounded-xl cursor-pointer focus:outline-none transition-colors text-sm font-medium border-none font-poppins"
            >
              <option value="">{t.srcformGTitle}</option>
              {/* Sesuai enum Laravel */}
        ...
        <button
          type="submit"
          className="bg-primary hover:opacity-90 text-white px-8 py-3 rounded-xl font-bold transition-all flex items-center justify-center gap-2 active:scale-95 shadow-lg font-poppins"
        >
